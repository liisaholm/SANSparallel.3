...
c
        ...
        INTEGER*8, PARAMETER :: MEMORY=500_long*giga ! 500 G 
        integer*8 :: lex,naa,offset,k,i,seq,ptr,seqlen
        integer*8, dimension(:), allocatable :: isa
        ...
        integer*8 :: sabuffer(bufsize),getsize,chunksize
        integer*8 :: seq_from,seq_to,outbuffer(bufsize)
